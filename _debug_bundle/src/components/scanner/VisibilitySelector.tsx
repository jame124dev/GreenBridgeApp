...
const styles = StyleSheet.create({
  label: { fontFamily: fonts.semibold, fontSize: 14, color: '#121c28', marginTop: 12, marginBottom: 8 },
  options: { gap: 8 },
  card: {
    padding: 14,
    borderRadius: 10,
  ...
  cardActive: { backgroundColor: '#14452f', borderColor: '#14452f' },
  cardTitle: { fontFamily: fonts.semibold, fontSize: 15, color: '#121c28' },
  cardTitleActive: { color: '#fff' },
  cardHint: { fontFamily: fonts.regular, fontSize: 12, color: '#6b7280', marginTop: 4 },
