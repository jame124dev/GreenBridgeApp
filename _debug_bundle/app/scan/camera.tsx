  ...
  return (
    <View style={styles.container}>
      ...
      <GestureDetector gesture={previewGesture}>
        {/* collapsable={false}: on the new architecture a GestureDetector child
            must not be view-flattened, or Fabric intermittently double-parents
            it during the mount commit ("addViewAt: child already has a parent"). */}
        <View style={StyleSheet.absoluteFill} pointerEvents="box-only" collapsable={false} />
      </GestureDetector>
